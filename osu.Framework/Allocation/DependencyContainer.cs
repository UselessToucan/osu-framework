        ...
        private MethodInfo getLoaderMethod(Type type)
        {
            ...
            if (loaderMethods.Length == 0)
                ...
                throw new InvalidOperationException(
                    $"The type {type.ReadableName()} has more than one method marked with the {nameof(BackgroundDependencyLoader)}-Attribute. Any given type can only have one such method.");
        }
